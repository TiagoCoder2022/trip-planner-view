...
export function DestinationAndDatesStep({
  closeGuestInput, 
  isGuestInputOpen, 
  openGuestInput, 
  setDestination,
  ...
  const displayedDate = eventStartAndEndDates && eventStartAndEndDates.from && eventStartAndEndDates.to
   ...
   : null
    ...
    return (
      <>
        <div className="md:hidden lg:hidden h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
          <div className="flex items-center gap-2 flex-1">
            <MapPin className="size-5 text-zinc-400"/>
            <input type="text" 
              disabled={isGuestInputOpen} 
              placeholder="Para onde você vai?" 
              className="bg-transparent text-md md:text-lg placehoder-zinc-400 outline-none flex-1"
      ...
      <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          >
            ...
            <span className="text-md md:text-lg text-zinc-400 w-40 flex-1">
