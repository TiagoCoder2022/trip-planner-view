                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-2.5">
                            ...
                            <p className="text-zinc-500 text-sm">Nunhuma atividade cadastrada nessa data.</p>
                        </div>
                        ...
                        <div className="space-y-2.5">
                            ...
                            <div className="space-y-2.5">
                                <div className="px-4 py-2.5 bg-zinc-900 rounded-xl shadow-shape flex items-center gap-3">
                                    ...
                                    <span className="text-zinc-100">Acedemia em grupo</span>
                ...
                <div className="w-80 space-y-6">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <a href="#" className="block text-xs text-zinc-400 truncate hover:text-zinc-200">
                                        https://www.airbnb.com.br/rooms/11224555533655522144552236547745652
                                    </a>
                                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    <span className="block font-medium text-zinc-100">Robert Castle</span>
                                    <span className="block text-sm text-zinc-400 truncate">
                                       robertcastle@email.com
                                    </span>
                                </div>
                                <CircleDashed className="text-zinc-400 size-5 shrink-0" />
                            </div>
